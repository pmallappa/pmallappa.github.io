...
#+DATE: 2024-12-25
#+EXPORT_FILE_NAME: hugo-getting-started
#+HUGO_BASE_DIR: ../../../../..
#+HUGO_SECTION: articles/2024/12/25
#+HUGO_TYPE: articles
#+HUGO_TAGS: hugo static-sites web-development tutorial
#+HUGO_CATEGORIES: technology
#+HUGO_CUSTOM_FRONT_MATTER: :series "Building Modern Static Sites with Hugo" :part 1 :summary "Learn how to install Hugo and create your first static website, understanding the basic project structure and configuration."
#+HUGO_DRAFT: false
...
Or download the latest release from [[https://github.com/gohugoio/hugo/releases][Hugo's GitHub releases]].
...
- [[https://discourse.gohugo.io/][Hugo Forums]]
