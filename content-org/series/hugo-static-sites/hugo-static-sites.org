...
#+DATE: 2024-12-25
#+HUGO_BASE_DIR: ../../../
#+HUGO_SECTION: series/hugo-static-sites
#+EXPORT_FILE_NAME: _index
#+OPTIONS: todo:nil author:nil
#+HUGO_DRAFT: false
#+HUGO_CATEGORIES: technology
#+HUGO_TAGS: hugo static-sites web-development jamstack
#+HUGO_CUSTOM_FRONT_MATTER: :type "series" :layout "_index" :series_count 6 :summary "Comprehensive guide to building high-performance static websites using Hugo, from setup to deployment, including advanced templating and content organization strategies."
...
- [[https://gohugo.io/][Hugo Official Documentation]]
- [[https://github.com/pmallappa/pmallappa.github.io][Project GitHub Repository]]
